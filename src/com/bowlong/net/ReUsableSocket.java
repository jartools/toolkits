...
public class ReUsableSocket {
	...
	protected com.bowlong.bio.BIOInputStream b1in;
	protected com.bowlong.bio.BIOOutputStream b1out;
	...
	public com.bowlong.bio.BIOInputStream b1in() {
		if (this.b1in == null)
			this.b1in = new com.bowlong.bio.BIOInputStream(this.in);
		return this.b1in;
	}

	public com.bowlong.bio.BIOOutputStream b1out() {
		if (this.b1out == null)
			this.b1out = new com.bowlong.bio.BIOOutputStream(this.out);
		return this.b1out;
	}
